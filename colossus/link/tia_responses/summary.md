...
## Steps Taken
1. **Resampling**: Resampled the waveforms to put them on a UI/32 time scale, where UI = 1 / 106.25 GHz (~9.41 ps). The time axis is now plotted in Units of Interval (UI).
...
3. **Frequency Domain Analysis**: We computed the Fast Fourier Transform (FFT) of the system responses (using the SBR pulse directly, and using the derivative for the Step Responses). The frequency domain results include:
...
### Step Responses (Impulse Derivative Included)

#### Attenuation 10 (Main 0.7, Tamerolloff Bypass PD)
**Ipd**
*Positive*:
![Ipd Pos Time](figures/step_response/attn10_main0p7_tamerolloff/Ipd_attn10_main0p7_tamerolloff_sweep_bypassPD_positive_time.png)
![Ipd Pos Freq](figures/step_response/attn10_main0p7_tamerolloff/Ipd_attn10_main0p7_tamerolloff_sweep_bypassPD_positive_freq.png)
*Negative*:
![Ipd Neg Time](figures/step_response/attn10_main0p7_tamerolloff/Ipd_attn10_main0p7_tamerolloff_sweep_bypassPD_negative_time.png)
![Ipd Neg Freq](figures/step_response/attn10_main0p7_tamerolloff/Ipd_attn10_main0p7_tamerolloff_sweep_bypassPD_negative_freq.png)

**Vbump**
*Positive*:
![Vbump Pos Time](figures/step_response/attn10_main0p7_tamerolloff/Vbump_attn10_main0p7_tamerolloff_sweep_bypassPD_positive_time.png)
![Vbump Pos Freq](figures/step_response/attn10_main0p7_tamerolloff/Vbump_attn10_main0p7_tamerolloff_sweep_bypassPD_positive_freq.png)
*Negative*:
![Vbump Neg Time](figures/step_response/attn10_main0p7_tamerolloff/Vbump_attn10_main0p7_tamerolloff_sweep_bypassPD_negative_time.png)
![Vbump Neg Freq](figures/step_response/attn10_main0p7_tamerolloff/Vbump_attn10_main0p7_tamerolloff_sweep_bypassPD_negative_freq.png)

#### Attenuation 11 (Tamerolloff)
**Ipd**
*Positive*:
![Ipd Pos Time](figures/step_response/attn11_tamerolloff/Ipd_attn11_tamerolloff_sweep_positive_time.png)
![Ipd Pos Freq](figures/step_response/attn11_tamerolloff/Ipd_attn11_tamerolloff_sweep_positive_freq.png)
*Negative*:
![Ipd Neg Time](figures/step_response/attn11_tamerolloff/Ipd_attn11_tamerolloff_sweep_negative_time.png)
![Ipd Neg Freq](figures/step_response/attn11_tamerolloff/Ipd_attn11_tamerolloff_sweep_negative_freq.png)

**Vbump**
*Positive*:
![Vbump Pos Time](figures/step_response/attn11_tamerolloff/Vbump_attn11_tamerolloff_sweep_positive_time.png)
![Vbump Pos Freq](figures/step_response/attn11_tamerolloff/Vbump_attn11_tamerolloff_sweep_positive_freq.png)
*Negative*:
![Vbump Neg Time](figures/step_response/attn11_tamerolloff/Vbump_attn11_tamerolloff_sweep_negative_time.png)
![Vbump Neg Freq](figures/step_response/attn11_tamerolloff/Vbump_attn11_tamerolloff_sweep_negative_freq.png)

#### Attenuation 11 (Xtmpeak)
**Ipd**
*Positive*:
![Ipd Pos Time](figures/step_response/attn11_xtmpeak/Ipd_attn11_xtmpeak_sweep_positive_time.png)
![Ipd Pos Freq](figures/step_response/attn11_xtmpeak/Ipd_attn11_xtmpeak_sweep_positive_freq.png)
*Negative*:
![Ipd Neg Time](figures/step_response/attn11_xtmpeak/Ipd_attn11_xtmpeak_sweep_negative_time.png)
![Ipd Neg Freq](figures/step_response/attn11_xtmpeak/Ipd_attn11_xtmpeak_sweep_negative_freq.png)

**Vbump**
*Positive*:
![Vbump Pos Time](figures/step_response/attn11_xtmpeak/Vbump_attn11_xtmpeak_sweep_positive_time.png)
![Vbump Pos Freq](figures/step_response/attn11_xtmpeak/Vbump_attn11_xtmpeak_sweep_positive_freq.png)
*Negative*:
![Vbump Neg Time](figures/step_response/attn11_xtmpeak/Vbump_attn11_xtmpeak_sweep_negative_time.png)
![Vbump Neg Freq](figures/step_response/attn11_xtmpeak/Vbump_attn11_xtmpeak_sweep_negative_freq.png)

#### Attenuation 12 (Tamerolloff)
**Ipd**
*Positive*:
![Ipd Pos Time](figures/step_response/attn12_tamerolloff/Ipd_attn12_tamerolloff_sweep_positive_time.png)
![Ipd Pos Freq](figures/step_response/attn12_tamerolloff/Ipd_attn12_tamerolloff_sweep_positive_freq.png)
*Negative*:
![Ipd Neg Time](figures/step_response/attn12_tamerolloff/Ipd_attn12_tamerolloff_sweep_negative_time.png)
![Ipd Neg Freq](figures/step_response/attn12_tamerolloff/Ipd_attn12_tamerolloff_sweep_negative_freq.png)

**Vbump**
*Positive*:
![Vbump Pos Time](figures/step_response/attn12_tamerolloff/Vbump_attn12_tamerolloff_sweep_positive_time.png)
![Vbump Pos Freq](figures/step_response/attn12_tamerolloff/Vbump_attn12_tamerolloff_sweep_positive_freq.png)
*Negative*:
![Vbump Neg Time](figures/step_response/attn12_tamerolloff/Vbump_attn12_tamerolloff_sweep_negative_time.png)
![Vbump Neg Freq](figures/step_response/attn12_tamerolloff/Vbump_attn12_tamerolloff_sweep_negative_freq.png)

#### Attenuation 12 (Xtmpeak)
**Ipd**
*Positive*:
![Ipd Pos Time](figures/step_response/attn12_xtmpeak/Ipd_attn12_xtmpeak_sweep_positive_time.png)
![Ipd Pos Freq](figures/step_response/attn12_xtmpeak/Ipd_attn12_xtmpeak_sweep_positive_freq.png)
*Negative*:
![Ipd Neg Time](figures/step_response/attn12_xtmpeak/Ipd_attn12_xtmpeak_sweep_negative_time.png)
![Ipd Neg Freq](figures/step_response/attn12_xtmpeak/Ipd_attn12_xtmpeak_sweep_negative_freq.png)

**Vbump**
*Positive*:
![Vbump Pos Time](figures/step_response/attn12_xtmpeak/Vbump_attn12_xtmpeak_sweep_positive_time.png)
![Vbump Pos Freq](figures/step_response/attn12_xtmpeak/Vbump_attn12_xtmpeak_sweep_positive_freq.png)
*Negative*:
![Vbump Neg Time](figures/step_response/attn12_xtmpeak/Vbump_attn12_xtmpeak_sweep_negative_time.png)
![Vbump Neg Freq](figures/step_response/attn12_xtmpeak/Vbump_attn12_xtmpeak_sweep_negative_freq.png)