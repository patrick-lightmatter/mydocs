...
The unified engineering report is `OCI_Link_Budget_Report.md`. A results-only digest
(tables and figures, minimal commentary) is `OCI_Link_Budget_Summary.md`; its two
figures are generated by `07_summary_figures.py`.
